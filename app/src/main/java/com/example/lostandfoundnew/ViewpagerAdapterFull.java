...
public class ViewpagerAdapterFull extends PagerAdapter {
    ...
    public ViewpagerAdapterFull(String[] paramArrayOfString, Context paramContext) {
    ...
    public Object instantiateItem(ViewGroup paramViewGroup, int paramInt) {
        ...
        View view = this.layoutInflater.inflate(R.layout.swipe_layout_full, paramViewGroup, false);
